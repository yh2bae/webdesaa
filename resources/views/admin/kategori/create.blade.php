            ...
            <div class="widget-one">
                ...
                <form action="{{ route('kategori.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="kategori_berita" type="text" name="kategori_berita" value="{{ old('kategori_berita') }}"
                            class="form-control @error('kategori_berita') is-invalid @enderror" placeholder="Masukan Nama Kategori Berita...">
