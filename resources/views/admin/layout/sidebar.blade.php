<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories ps" id="accordionExample">
            <li class="menu">
                <a href="{{ route('dashboard') }}" data-active="{{ set_true('dashboard') }}" aria-expanded="false"
            ...
            @if(user_akses2('penduduk',Session()->get('level'))->view ?? 0 =='1' OR
            user_akses2('dusun',Session()->get('level'))->view ?? 0 =='1')
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled {{ set_show('dusun.index') }} {{ set_show('dusun.create') }} {{ set_show('dusun.edit') }} {{ set_show('penduduk.index') }} {{ set_show('penduduk.create') }} {{ set_show('penduduk.edit') }} @if (Request::segment(2) == 'anggaran-realisasi' || Request::segment(2) == 'tambah-anggaran-realisasi') show @endif"
                    id="kelola" data-parent="#accordionExample">

                    @if(user_akses2('penduduk',Session()->get('level'))->view ?? 0 =='1')
                    <li
                        class="{{ set_active('penduduk.index') }} {{ set_active('penduduk.create') }} {{ set_active('penduduk.edit') }}">
                    ...
                    <li
                        class="{{ set_active('dusun.index') }} {{ set_active('dusun.create') }} {{ set_active('dusun.edit') }}">
                    ...
                    <li
                        class="@if (Request::segment(2) == 'anggaran-realisasi' || Request::segment(2) == 'tambah-anggaran-realisasi') active @endif">
                        <a href="{{ url('admin-panel/anggaran-realisasi?jenis=pendapatan&tahun='.date('Y')) }}"> Kelolah
                            APBDes </a>
                    </li>
                    @endif
            ...
            @if(user_akses2('berita',Session()->get('level'))->view ?? 0 =='1' OR
            user_akses2('kategori_berita',Session()->get('level'))->view ?? 0 =='1')
            <li class="menu">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled {{ set_show('desa.index') }} {{ set_show('configuration.index') }} {{ set_show('slider.index') }} {{ set_show('slider.create') }} {{ set_show('slider.edit') }}"
                    ...
                    <li
                        class="{{ set_active('slider.index') }} {{ set_active('slider.create') }} {{ set_active('slider.edit') }}">
                    ...
                    <li
                        ...
                        <a href="{{ route('struktur.index') }}"> Kelolah Struktur Desa </a>
                    </li>
                    @endif
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled {{ set_show('user.index') }} {{ set_show('user.create') }} {{ set_show('user.edit') }} {{ set_show('role.index') }} {{ set_show('role.create') }} {{ set_show('role.edit') }} {{ set_show('role.access') }}"
                    id="submenu" data-parent="#accordionExample">

                    @if(user_akses2('user',Session()->get('level'))->view ?? 0 =='1')
                    <li
                        class="{{ set_active('user.index') }} {{ set_active('user.create') }} {{ set_active('user.edit') }}">
                    ...
                    <li
                        class="{{ set_active('role.index') }} {{ set_active('role.create') }} {{ set_active('role.edit') }} {{ set_active('role.access') }}">
