    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories ps" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled {{ set_show('dusun.index') }} {{ set_show('dusun.create') }} {{ set_show('dusun.edit') }} {{ set_show('penduduk.index') }} {{ set_show('penduduk.create') }} {{ set_show('penduduk.edit') }}  {{ set_show('penduduk.index') }} 
                {{ set_show('penduduk.create') }} {{ set_show('penduduk.edit') }}"
            ...
            user_akses2('kategori',Session()->get('level'))->view ?? 0 =='1')
            <li class="menu">
            ...
            <li class="menu">
                <a href="{{ route('desa.index') }}" data-active="{{ set_true('desa.index') }}" aria-expanded="false"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
