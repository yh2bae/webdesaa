...
@if(user_akses2('kepala-desa',Session()->get('level'))->input ?? 0 =='1')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="masa_jabatan" type="text" name="masa_jabatan" value="{{ old('masa_jabatan') }}"
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            id="keterangan" placeholder="Masukkan Keterangan ...">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
