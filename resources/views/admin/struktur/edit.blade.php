...
@section('head-title')
<title>Desa {{ $desa->nama_desa }} - Tambah Struktu Desa</title>
@endsection
        ...
        <div class="widget widget-content-area br-4 mt-2" style="background: #f7fafc">
            <div class="widget-one">
                ...
                <form action="{{ route('struktur.update', $struktur) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name', $struktur->name) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="position" type="text" name="position" value="{{ old('position',$struktur->position) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="niap" type="number" name="niap" value="{{ old('niap',$struktur->niap) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="tempat_lahir" type="text" name="tempat_lahir"
                                    value="{{ old('tempat_lahir',$struktur->tempat_lahir) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="tanggal_lahir" type="text" name="tanggal_lahir"
                                    value="{{ old('tanggal_lahir',$struktur->tanggal_lahir) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="selectpicker @error('pendidikan_id') is-invalid @enderror"
                                        ...
                                        @if ($item->id == $struktur->pendidikan_id)
                                        <option value={{ $item->id }} selected='selected'> {{ $item->nama }} </option>
                                        @else
                                        <option value=" {{ $item->id }} "> {{ $item->nama }} </option>
                                        @endif
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="nomor_sk" type="number" name="nomor_sk" value="{{ old('nomor_sk',$struktur->nomor_sk) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="tanggal_sk" type="text" name="tanggal_sk" value="{{ old('tanggal_sk',$struktur->tanggal_sk) }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="masa_jabatan" type="number" name="masa_jabatan"
                                    value="{{ old('masa_jabatan',$struktur->masa_jabatan) }}"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" name="address"
                                    id="address" placeholder="Masukkan Alamat ...">{{ old('address',$struktur->address) }}</textarea>
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="selectpicker @error('status') is-invalid @enderror" name="status"
                                        ...
                                        <option value="1" {{ old('status',$struktur->status) == 1 ? 'selected="true"' : ''  }}>Aktif
                                        </option>
                                        <option value="2" {{ old('status',$struktur->status) == 2 ? 'selected="true"' : ''  }}>Tidak Aktif
                                        </option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <button type="submit" class="btn btn-primary btn-block mt-3" id="simpan">Ubah Data</button>
