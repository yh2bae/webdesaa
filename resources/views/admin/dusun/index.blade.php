...
@section('head-title')
<title>Desa {{ $desa->nama_desa }} - Dusun</title>
@endsection
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a href="{{ route('dusun.create') }}" class="btn btn-primary float-right mt-2">+ Tambah dusun</a>  
                        @endif   
                    </div>
                </div>
            </div>
            ...
            <table id="dtable" class="table dt-table-hover" style="width:100%">
                <thead>
                    <tr>
                        ...
                        @if(user_akses2('dusun',Session()->get('level'))->update ?? 0 =='1' OR user_akses2('dusun',Session()->get('level'))->delete ?? 0 =='1')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form onsubmit="return confirm('Apa kamu yakin ingin menghapus dusun {{ $s->nama }} ?');"
                                action="{{ route('dusun.destroy', $s->id) }}"
                                method="POST">

                                @if(user_akses2('dusun',Session()->get('level'))->update ?? 0 =='1')
                                <a href="{{ route('dusun.edit', $s->id) }}" title="Edit" class="btn btn-primary btn-sm">
                                    <i class="far fa-edit"></i>
                                </a>
                                @endif
                                
                                @if(user_akses2('dusun',Session()->get('level'))->delete ?? 0 =='1')
