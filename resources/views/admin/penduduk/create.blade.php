                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="kk" type="text" name="kk" value="{{ old('kk') }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="tanggal_lahir" type="text" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="form-control flatpickr flatpickr-input active @error('tanggal_lahir') is-invalid @enderror" placeholder="Pilih Tanggal Lahir">
                                @error('tanggal_lahir')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="nomor_paspor" type="text" name="nomor_paspor" value="{{ old('nomor_paspor') }}"
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="nomor_kitas_atau_kitap" type="text" name="nomor_kitas_atau_kitap" value="{{ old('nomor_kitas_atau_kitap') }}"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="nik_ayah" type="text" name="nik_ayah" value="{{ old('nik_ayah') }}"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="nama_ayah" type="text" name="nama_ayah" value="{{ old('nama_ayah') }}"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="nik_ibu" type="text" name="nik_ibu" value="{{ old('nik_ibu') }}"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="nama_ibu" type="text" name="nama_ibu" value="{{ old('nama_ibu') }}"
