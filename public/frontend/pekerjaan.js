$(document).ready(function (){
    $.getJSON(baseURL + '/statistik-penduduk/show', function(response) {
        ...
        let chart_perkawinan = Highcharts.chart('chart-pekerjaan', pie);
        chart_perkawinan.title.textSetter("Grafik Pekerjaan");
        chart_perkawinan.series[0].setData(response.pekerjaan);
