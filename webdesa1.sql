...
INSERT INTO `berita` (`id`, `title`, `slug`, `kategori_id`, `description`, `tanggal_publish`, `image`, `publish`, `writer`, `created_at`, `updated_at`) VALUES
(1, 'ss', 'ss', 1, 'ssasaa', '2021-05-12', '1632121477-Screen Shot 2021-09-20 at 13.37.46.png', 'Tidak', 'sakti', '2021-09-20 00:04:37', '2021-09-20 19:19:51'),
(2, 'revisi', 'revisi', 2, 'rrr', '2022-05-12', '1632129220-Screen Shot 2021-09-13 at 10.06.09.png', 'Ya', 'sakti', '2021-09-20 02:13:40', '2021-09-20 02:13:40');
...
(1, 'baru', '2021-09-19 21:09:20', '2021-09-19 21:09:20'),
...
(21, '2021_09_21_022726_create_strukturs_table', 8);
...
(6, 'Kelola Kategori Berita', 'kategori', 'Y'),
(7, 'Kelola Berita', 'berita', 'Y'),
(8, 'Kelola Kategori Berita', 'kategori', 'Y'),
(9, 'Kelola Struktur Desa', 'struktur', 'Y');
...
(9, 1, 6, 1, 1, 1, 1, 0, NULL, NULL),
(10, 1, 7, 1, 1, 1, 1, 0, NULL, NULL),
(11, 1, 8, 1, 1, 1, 1, 0, NULL, NULL),
(12, 1, 9, 1, 1, 1, 1, 0, NULL, NULL);
...
--
ALTER TABLE `moduls`
  MODIFY `id_modul` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
